window.__REDVEIL_PAYLOAD__ = {
  ...
  "districts": [
    {
      ...
      "memo": "서초구는 78.9점, '매우 높음' 구간입니다. 현재 이 구의 대표 유형은 '고가 선행형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다, 상권 내 점포 과밀도가 높습니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 금천구, 관악구, 양천구 등 대체 후보를 먼저 비교하세요.",
    ...
    },
    {
      ...
      "memo": "강남구는 71.8점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '고가 선행형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다, 상권 내 점포 과밀도가 높습니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 구로구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "고가 선행형",
      "archetypeSummary": "가격이 먼저 뛰고 변동성도 큰 유형입니다. 중개사 설명보다 최근 체결 레벨 확인이 우선입니다.",
      "decisionQuestion": "호가가 최근 거래선보다 앞서 있는지 먼저 확인해야 합니다.",
      "recommendedAction": "실거래 3건 이상 재확인 후 대체 구와 가격선을 비교하세요.",
    ...
    },
    {
      ...
      "memo": "중구는 70.2점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '고가 선행형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 관악구, 강서구, 은평구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "고가 선행형",
      "archetypeSummary": "가격이 먼저 뛰고 변동성도 큰 유형입니다. 중개사 설명보다 최근 체결 레벨 확인이 우선입니다.",
      "decisionQuestion": "호가가 최근 거래선보다 앞서 있는지 먼저 확인해야 합니다.",
      "recommendedAction": "실거래 3건 이상 재확인 후 대체 구와 가격선을 비교하세요.",
    ...
    },
    {
      ...
      "memo": "종로구는 67.6점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '과밀 경쟁형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다, 상권 내 점포 과밀도가 높습니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 관악구, 은평구, 강서구 등 대체 후보를 먼저 비교하세요.",
    ...
    },
    {
      ...
      "memo": "용산구는 64.9점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '가격 변동형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 관악구, 은평구, 강서구 등 대체 후보를 먼저 비교하세요.",
    ...
    },
    {
      ...
      "memo": "영등포구는 63.4점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '과밀 경쟁형'이며, 핵심 반대 근거는 상권 내 점포 과밀도가 높습니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 관악구, 강서구, 은평구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "과밀 경쟁형",
      "archetypeSummary": "입지는 익숙하지만 이미 상권 과밀이 높은 유형입니다. 임차인 교체 속도가 수익을 좌우합니다.",
      "decisionQuestion": "같은 형식의 점포가 얼마나 중복되어 있는지 확인해야 합니다.",
      "recommendedAction": "핵심 행정동을 돌며 중복 업종과 공실 교체 패턴을 직접 확인하세요.",
    ...
    },
    {
      ...
      "riskSummary": "최근 가격 변동성이 커서 체결 레벨 재확인이 필요합니다",
      "memo": "송파구는 62.4점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '가격 변동형'이며, 핵심 반대 근거는 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 양천구, 강서구, 금천구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "가격 변동형",
      "archetypeSummary": "가격 레벨은 버틸 수 있어도 최근 체결선이 불안정한 유형입니다.",
      "decisionQuestion": "최근 몇 건이 전체 시장을 왜곡한 이상 거래인지 살펴봐야 합니다.",
      "recommendedAction": "대형 거래와 집합상가 거래를 분리해 재해석하세요.",
    ...
    },
    {
      ...
      "memo": "마포구는 62.3점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '과밀 경쟁형'이며, 핵심 반대 근거는 상권 내 점포 과밀도가 높습니다. 바로 매입을 결정하기보다 관악구, 은평구, 강서구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "과밀 경쟁형",
      "archetypeSummary": "입지는 익숙하지만 이미 상권 과밀이 높은 유형입니다. 임차인 교체 속도가 수익을 좌우합니다.",
      "decisionQuestion": "같은 형식의 점포가 얼마나 중복되어 있는지 확인해야 합니다.",
      "recommendedAction": "핵심 행정동을 돌며 중복 업종과 공실 교체 패턴을 직접 확인하세요.",
    ...
    },
    {
      ...
      "memo": "강동구는 59.0점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '거래 둔화형'이며, 핵심 반대 근거는 거래 유동성이 약해지고 있습니다, 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 강서구, 관악구, 동대문구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
    ...
    },
    {
      ...
      "memo": "성동구는 58.5점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '가격 변동형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다, 최근 실거래 가격 변동성이 큽니다. 바로 매입을 결정하기보다 강서구, 구로구, 광진구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "가격 변동형",
      "archetypeSummary": "가격 레벨은 버틸 수 있어도 최근 체결선이 불안정한 유형입니다.",
      "decisionQuestion": "최근 몇 건이 전체 시장을 왜곡한 이상 거래인지 살펴봐야 합니다.",
      "recommendedAction": "대형 거래와 집합상가 거래를 분리해 재해석하세요.",
    ...
    },
    {
      ...
      "memo": "성북구는 57.0점, '높음' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 같은 권역 대비 매입 가격 부담이 큽니다. 바로 매입을 결정하기보다 관악구, 강서구, 노원구 등 대체 후보를 먼저 비교하세요.",
    ...
    },
    {
      ...
      "memo": "양천구는 54.5점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 강서구, 노원구, 광진구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "riskSummary": "즉시 배제할 수준은 아니지만 매물 단위 검토가 필요한 구입니다",
      "memo": "관악구는 50.3점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 한 가지 축만 위험한 것은 아니지만 복합 검토가 필요한 구입니다. 바로 매입을 결정하기보다 은평구, 강서구, 노원구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "riskSummary": "최근 표본이 적어 현장 검증 비중을 높여야 합니다",
      "memo": "금천구는 50.2점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 강서구, 은평구, 노원구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "memo": "동작구는 47.0점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '거래 둔화형'이며, 핵심 반대 근거는 거래 유동성이 약해지고 있습니다, 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 도봉구, 구로구, 광진구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "거래 둔화형",
      "archetypeSummary": "매물은 보이지만 거래가 얇아지는 유형입니다. 단기 회전과 매도 유동성이 약할 수 있습니다.",
      "decisionQuestion": "팔고 싶을 때 바로 빠져나올 수 있는 시장인지 점검해야 합니다.",
      "recommendedAction": "최근 6개월 거래 수와 체결 속도를 중개 재고와 함께 확인하세요.",
    ...
    },
    {
      ...
      "memo": "서대문구는 45.5점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '거래 둔화형'이며, 핵심 반대 근거는 거래 유동성이 약해지고 있습니다, 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 강북구, 광진구, 도봉구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "거래 둔화형",
      "archetypeSummary": "매물은 보이지만 거래가 얇아지는 유형입니다. 단기 회전과 매도 유동성이 약할 수 있습니다.",
      "decisionQuestion": "팔고 싶을 때 바로 빠져나올 수 있는 시장인지 점검해야 합니다.",
      "recommendedAction": "최근 6개월 거래 수와 체결 속도를 중개 재고와 함께 확인하세요.",
    ...
    },
    {
      ...
      "riskSummary": "즉시 배제할 수준은 아니지만 매물 단위 검토가 필요한 구입니다",
      "memo": "강서구는 44.2점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 한 가지 축만 위험한 것은 아니지만 복합 검토가 필요한 구입니다. 바로 매입을 결정하기보다 노원구, 은평구, 광진구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "memo": "동대문구는 44.0점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '거래 둔화형'이며, 핵심 반대 근거는 거래 유동성이 약해지고 있습니다. 바로 매입을 결정하기보다 노원구, 은평구, 광진구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "거래 둔화형",
      "archetypeSummary": "매물은 보이지만 거래가 얇아지는 유형입니다. 단기 회전과 매도 유동성이 약할 수 있습니다.",
      "decisionQuestion": "팔고 싶을 때 바로 빠져나올 수 있는 시장인지 점검해야 합니다.",
      "recommendedAction": "최근 6개월 거래 수와 체결 속도를 중개 재고와 함께 확인하세요.",
    ...
    },
    {
      ...
      "memo": "중랑구는 42.6점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '거래 둔화형'이며, 핵심 반대 근거는 거래 유동성이 약해지고 있습니다, 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 광진구, 노원구, 도봉구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "거래 둔화형",
      "archetypeSummary": "매물은 보이지만 거래가 얇아지는 유형입니다. 단기 회전과 매도 유동성이 약할 수 있습니다.",
      "decisionQuestion": "팔고 싶을 때 바로 빠져나올 수 있는 시장인지 점검해야 합니다.",
      "recommendedAction": "최근 6개월 거래 수와 체결 속도를 중개 재고와 함께 확인하세요.",
    ...
    },
    {
      ...
      "memo": "강북구는 39.9점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '거래 둔화형'이며, 핵심 반대 근거는 거래 유동성이 약해지고 있습니다, 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 광진구, 구로구, 은평구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "거래 둔화형",
      "archetypeSummary": "매물은 보이지만 거래가 얇아지는 유형입니다. 단기 회전과 매도 유동성이 약할 수 있습니다.",
      "decisionQuestion": "팔고 싶을 때 바로 빠져나올 수 있는 시장인지 점검해야 합니다.",
      "recommendedAction": "최근 6개월 거래 수와 체결 속도를 중개 재고와 함께 확인하세요.",
    ...
    },
    {
      ...
      "riskSummary": "최근 표본이 적어 현장 검증 비중을 높여야 합니다",
      "memo": "도봉구는 37.0점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 최근 상가 거래 표본이 적어 해석에 주의가 필요합니다. 바로 매입을 결정하기보다 구로구, 광진구 등 대체 후보를 먼저 비교하세요. 최근 거래 표본이 적어 현장 검증 비중을 높여야 합니다.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "riskSummary": "즉시 배제할 수준은 아니지만 매물 단위 검토가 필요한 구입니다",
      "memo": "노원구는 35.9점, '보통' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 한 가지 축만 위험한 것은 아니지만 복합 검토가 필요한 구입니다. 바로 매입을 결정하기보다 구로구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "riskSummary": "즉시 배제할 수준은 아니지만 매물 단위 검토가 필요한 구입니다",
      "memo": "은평구는 34.3점, '낮음' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 한 가지 축만 위험한 것은 아니지만 복합 검토가 필요한 구입니다. 바로 매입을 결정하기보다 구로구 등 대체 후보를 먼저 비교하세요.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
    ...
    },
    {
      ...
      "riskSummary": "즉시 배제할 수준은 아니지만 매물 단위 검토가 필요한 구입니다",
      "memo": "구로구는 27.6점, '낮음' 구간입니다. 현재 이 구의 대표 유형은 '복합 점검형'이며, 핵심 반대 근거는 한 가지 축만 위험한 것은 아니지만 복합 검토가 필요한 구입니다. 지금 바로 매입 결정을 내리기보다 현재 조건에서는 별도 대체 후보가 없어 현장 확인을 우선하세요.",
      "riskArchetype": "복합 점검형",
      "archetypeSummary": "한 축만 위험하지는 않지만 여러 신호가 중간 수준으로 겹쳐 있는 유형입니다.",
      "decisionQuestion": "매입 결정을 서두르기보다 케이스별 검증 항목을 쌓아야 합니다.",
      "recommendedAction": "현장 답사와 대체 구 비교를 동시에 진행하세요.",
  ...
  "content": {
    "thesis": {
      ...
      "body": "Redveil은 가격 부담, 거래 둔화, 상권 과밀, 수요 취약을 먼저 확인하는 매입 판단 도구입니다."
    },
    "northStar": {
      "title": "잘못된 매입을 줄이는 판단 엔진",
      "body": "추천보다 보류 판단을 빠르게 만드는 것이 목표입니다."
    },
    "personas": [
      {
        "title": "개인 투자자",
        "description": "현장 답사 전에 빠른 1차 리스크 판별이 필요한 투자자"
      },
      {
        "title": "중개 실무자",
        "description": "추천보다 반대 근거와 대체 구를 함께 제시해야 하는 실무자"
      },
      {
        "title": "분석형 PM/애널리스트",
        "description": "분석 결과가 실제 제품 흐름으로 이어지는 방식을 보는 사용자"
      }
    ],
    "useCases": [
      {
    ...
    "modules": [
      {
        "title": "내 매물 검토",
        "body": "매물을 저장하고 바로 판정합니다."
      },
      {
        "title": "3분 진단",
        "body": "가격선과 보유 기간을 넣고 빠르게 걸러냅니다."
      },
      {
        "title": "후보 비교",
        "body": "2~3개 구를 같은 기준으로 붙여 봅니다."
      },
      {
        "title": "구 리포트",
        "body": "메모, 하위 점수, 추세를 한 화면에서 확인합니다."
      }
    ],
    "decisionStages": [
      {
        "title": "1차 필터링",
        "body": "보류할지, 더 볼지 먼저 정합니다."
      },
      {
        "title": "현장 검증",
        "body": "유형별 체크리스트로 확인 항목을 좁힙니다."
      },
      {
        "title": "대체 검토",
        "body": "같은 예산에서 더 안전한 구를 붙여 봅니다."
      },
      {
        "title": "최종 메모",
        "body": "결론과 다음 액션을 남깁니다."
      }
    ],
    "trustSignals": [
      {
        "title": "실거래 12,074건 기반",
        "body": "2026.03 기준 최근 12개월 실거래를 반영했습니다."
      },
      {
        "title": "25개 구 전수 커버",
    ...
    "faq": [
      {
        ...
        "answer": "아니요. 먼저 멈춰야 할 이유와 대체 구를 보여줍니다."
      },
      {
        "question": "개별 건물의 정확한 수익률을 예측하나요?",
        "answer": "아니요. 1차 판별 도구이며 임대차와 건물 상태는 별도 검증이 필요합니다."
      },
      {
        "question": "왜 수요 데이터와 거래 데이터 시점이 다르나요?",
        "answer": "공개 데이터 갱신 주기가 달라서입니다. 시점 차이는 화면과 문서에 함께 표시합니다."
      }
    ],
    "dataSources": [
      {
    ...
    "limitations": [
      "개별 건물의 임대차 조건과 관리 상태는 포함하지 않습니다.",
  ...
  "methodology": {
    "problemStatement": "Redveil은 매입 전에 숨은 위험 신호를 먼저 드러내는 판단 도구입니다.",
    "pillars": [
