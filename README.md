...
![Redveil 대표 화면](./dashboard/README_HERO.png)

![Redveil 근거 시각화](./dashboard/README_EVIDENCE.png)
...
- `README_HERO.png`는 메인 화면, 구 리스크 검토, 케이스 스터디를 한 번에 보여주는 소개용 비주얼입니다.
- `README_EVIDENCE.png`는 수요 취약과 행정동 과밀 화면을 다시 묶어 점수의 근거가 어떻게 보이는지 보여줍니다.
