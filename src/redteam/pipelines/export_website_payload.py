...
def build_content(summary: dict[str, object], latest_month: str) -> dict[str, object]:
    return {
        ...
        "modules": [
            {"title": "내 매물 검토", "body": "매물을 저장하고 바로 판정합니다."},
            {"title": "3분 진단", "body": "가격선과 보유 기간을 넣고 빠르게 걸러냅니다."},
            {"title": "후보 비교", "body": "2~3개 구를 같은 기준으로 붙여 봅니다."},
            {"title": "구 리포트", "body": "메모, 하위 점수, 추세를 한 화면에서 확인합니다."},
        ],
        "decisionStages": [
            {"title": "1차 필터링", "body": "보류할지, 더 볼지 먼저 정합니다."},
            {"title": "현장 검증", "body": "유형별 체크리스트로 확인 항목을 좁힙니다."},
            {"title": "대체 검토", "body": "같은 예산에서 더 안전한 구를 붙여 봅니다."},
            {"title": "최종 메모", "body": "결론과 다음 액션을 남깁니다."},
        ],
        "trustSignals": [
            {
