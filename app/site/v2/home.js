(function () {
  ...
  if (!payload) {
    document.body.innerHTML = `
      <main style="padding:40px;color:#f4efe7;background:#08121d;font-family:'IBM Plex Sans KR',sans-serif">
        ...
        <p><code>../site/website_payload.js</code> 경로가 유효한지 확인하세요.</p>
      </main>
    `;
    return;
  }
  ...
  function renderHero() {
    document.getElementById("hero-description").textContent =
      "Redveil 새 버전은 랜딩 페이지를 넘어서, 첫 화면에서 바로 구 리스크를 시뮬레이션하고 다음 행동까지 읽히게 만드는 방향으로 설계했습니다.";
      ...
      reviews.length > 0
        ...
        : `
          <article class="review-mini">
            ...
            <p>기존 버전의 내 매물 검토에서 결과를 저장하면 여기에도 즉시 반영됩니다.</p>
          </article>
        `;
  }
